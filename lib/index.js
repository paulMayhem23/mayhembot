...
//					log("setting count: " + arg);
	...
	'about': {
		command: function(options) {
			options.cmbot.speakOrPM("@MayhemBOT " + options.cmbot.VERSION + " hacked by Paulmayhem. Based heavily on https://github.com/atomjack/cmbot", options.pm, options.userid);
		},
		modonly: false,
		pmonly: false,
		help: 'About me.'
